...
/**
 * SCI1 Register Mapping
 *
 * +-----+----------+----+---------------------------------------+
 * | SMR | 0xffffb8 | 1B | mode settings of serial communication |
 * +-----+----------+----+---------------------------------------+
 * | BRR | 0xffffb9 | 1B | portr ate settings                    |
 * +-----+----------+----+---------------------------------------+
 * | SCR | 0xffffba | 1B | enable/disable send-receive           |
 * +-----+----------+----+---------------------------------------+
 * | TDR | 0xffffbb | 1B | write byte to send                    |
 * +-----+----------+----+---------------------------------------+
 * | SSR | 0xffffbc | 1B | flags of send-receive completion      |
 * +-----+----------+----+---------------------------------------+
 * | RDR | 0xffffbd | 1B | read byte received                    |
 * +-----+----------+----+---------------------------------------+
 */
